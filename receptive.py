...
root_dir = 'C:\\Users\\Laila\\InceptionTime\\temp-dl-tsc'
root_output_directory = os.path.join(root_dir, 'receptive-field', 'exp')
root_output_directory_df = os.path.join(root_dir ,'receptive-field')
                            ...
                            for filters in filters_s:
                                ...
                                for use_residual in use_residuals:
                                    ...
                                    for use_bottleneck in use_bottlenecks:
                                        ...
                                        'pattern_len_' + '_'.join(str(e) for e in pattern_len),
                                        'pattern_pos_' + '_'.join(str(e) for e in pattern_pos),
                                        'ts_len_' + str(ts_len),
                                        'ts_n_' + str(ts_n),
                                        'nb_classes_' + str(nb_classes),
                                        'filters_' + str(filters),
                                        'kernel_size_' + str(kernel_size),
                                        'depth_' + str(depth),
                                        'use_residual_' + str(use_residual),
                                        'use_bottleneck_' + str(use_bottleneck),
)
